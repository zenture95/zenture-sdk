...
Use `https://www.zenture.app/api-documentation` for human-facing API context,
...
examples must use explicit stable idempotency keys or keys generated through the
